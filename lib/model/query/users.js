...
update formulario_permitidos set permitidos=${limite} where "id"=${id}
`;
...
const getUpdateLimite = (id, limite) => ({ all }) => all(_getSqlformsNull(id, limite));
...
module.exports = {
  ...
  emailEverExisted,
  getFormsNull, getFormsAll, getUpdateLimite
};
