...
module.exports = (service, endpoint) => {
  ...
  // streamAttachment();
    ...
    // Nonstandard REST; OpenRosa-specific API.
    service.post(path, multipart.any(), multerUtf,streamAttachment, endpoint.openRosa(async({ Forms, Submissions, SubmissionAttachments }, { params, files, auth, query, userAgent }) => 
    Submission.fromXml(findMultipart(files).buffer)
        .then((partial) => getForm(auth, params, partial.xmlFormId, Forms, partial.def.version)
          ...
          .then((form) => {
            ...
            // Submission.getTotalRegistros((registros) => {
